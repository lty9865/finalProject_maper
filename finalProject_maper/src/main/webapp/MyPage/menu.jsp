...
<head>
  <meta charset="UTF-8">
  <title>My Page</title>
  <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/Resources/css/myPage_menu.css">
</head>
<body>
  <div class="container">
    ...
    <div class="mapper-myPage-menu-container">
      <ul class="mapper-myPage-horizontal-menu">
        <li class="mapper-myPage-menu-item">
          <a href="${pageContext.request.contextPath}/MyPage/MyPageFront?command=MyRequest">
            내 문의
          </a>
        </li>
      </ul>
