...
<body>
  ...
  <form action="${pageContext.request.contextPath}/MyPage/MyPageFront?command=MyRequest.requestPostProcess" method="POST">
    <input type="hidden" name="command" value="WritePost">
    <table class="table">
	  <tr>
        <td>
          <h4>제목</h4>
          <input type="text" name="title" value="${selectedRequest.title}"
      ...
      <tr>
        <td>
          ...
          <textarea cols="90" rows="15" name="content" required="required" 
            placeholder=" 본문내용을 입력하세요">${selectedRequest.content}</textarea>
        </td>
      </tr>
	  <tr>
        <td>
