...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="index.jsp">MAPER</a>
		</div>
	</nav>
	<div id="carouselExampleCaptions" class="carousel slide">
		...
		<div class="carousel-inner opacity-75">
			<div class="carousel-item active">
				<img src="Resources/assets/img/thumnail/drink.jpg" class="d-block w-100" alt="...">
			...
			<div class="carousel-item">
				<img src="Resources/assets/img/thumnail/notice.jpg" class="d-block w-100" alt="...">
				<div class="carousel-caption d-none d-md-block">
					<h1>Title</h1>
					<br>
					<p>Some representative placeholder content for the first slide.</p>
			...
			<div class="carousel-item">
				<img src="Resources/assets/img/thumnail/travel.jpg" class="d-block w-100" alt="...">
				<div class="carousel-caption d-none d-md-block">
					<h1>Title</h1>
					<br>
					<p>Some representative placeholder content for the first slide.</p>
