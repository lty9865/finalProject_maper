...
<body>
	...
	<div class="maper-body">
		...
		<form action="../Book/bookEdit.do" name="bookEditFrm" method="post" enctype="multipart/form-data"
		onsubmit="">
		<!-- 임시계정 -->
		...
		<div class="bookWrite">
			<div class="mapers-book-inputbar" style="padding-left: 20px;">
				...
				<input class="main-inputbar" style="width: 85%;" type="text"
					name="title" id="title" value="${ dto.title }">
			</div>
			<div class="parent">
				...
				<div class="mapers-book-inputbar child" style="padding-left: 20px;">
					...
					<input class="main-inputbar" style="width: 70%; padding-left: 20px;" type="text" id="city" name="city" value="${ city }">
				</div>&nbsp;
				<div class="mapers-book-inputbar child" style="padding-left: 20px;">
					<label class="main-inputbar" for="date">일자</label>
					<input class="main-inputbar" style="width: 70%; padding-left: 20px;" type="date" id="date" name="bookDate" value="${dto.bookDate }">
				</div>
			</div>
			...
			<button type="button" class="btn btn-primary" onclick="location.href='../Book/bookList.do';">돌아가기</button>
		</form>
	</div>
</body>
</html>