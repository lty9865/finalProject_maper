...
CREATE TABLE BOOK(
	...
	CONSTRAINT FK_BOOK FOREIGN KEY(USERID) REFERENCES ACCOUNT(USERID)
);
...
CREATE TABLE PAGE(
	...
	RATE INT DEFAULT 5 NOT NULL,
	CONSTRAINT FK_PAGE FOREIGN KEY(BOOKNUM) REFERENCES BOOK(BOOKNUM)
);
...
CREATE TABLE PAGEVIEW(
	...
	CONSTRAINT FK_PAGEVIEW FOREIGN KEY(BOOKNUM) REFERENCES BOOK(BOOKNUM),
	CONSTRAINT FK_PAGEVIEW FOREIGN KEY(PAGENUM) REFERENCES PAGE(PAGENUM),
	CONSTRAINT FK_PAGEVIEW FOREIGN KEY(USERID) REFERENCES ACCOUNT(USERID)
);
